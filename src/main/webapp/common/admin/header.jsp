...
<header id="header" class="header fixed-top d-flex align-items-center">
	...
	<div class="d-flex align-items-center justify-content-between">
		<a href="index.html" class="logo d-flex align-items-center"> <img
			src="/templates/admin/assets/img/logo.png" alt=""> <span
		...
		<ul class="d-flex align-items-center">
			...
			<li class="nav-item dropdown"><a class="nav-link nav-icon"
				...
				<ul
					...
					<li class="message-item"><a href="#"> <img
							src="/templates/admin/assets/img/messages-1.jpg" alt=""
					...
					<li class="message-item"><a href="#"> <img
							src="/templates/admin/assets/img/messages-2.jpg" alt=""
							class="rounded-circle">
							<div>
								<h4>Anna Nelson</h4>
								<p>Velit asperiores et ducimus soluta repudiandae labore
					...
					<li class="message-item"><a href="#"> <img
							src="/templates/admin/assets/img/messages-3.jpg" alt=""
							class="rounded-circle">
							<div>
								<h4>David Muldon</h4>
								<p>Velit asperiores et ducimus soluta repudiandae labore
			...
			<li class="nav-item dropdown pe-3"><a
				...
				data-bs-toggle="dropdown"> <img
					src="/templates/images/${staff.image}" alt="Profile"
					class="rounded-circle"> <span
					class="d-none d-md-block dropdown-toggle ps-2"><%= SecurityUtils.getPrincipal().getFullName()%></span>
			</a> <!-- End Profile Iamge Icon -->

				<ul
					class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
					<li class="dropdown-header">
						<h6>${staff.surname} ${staff.name}</h6> <span>${staff.account.position.name}</span>
					</li>
					<li>
						<hr class="dropdown-divider">
					</li>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="/admin/profile"> <i class="bi bi-person"></i> <span>Thông tin</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
					</li>
					<li><a class="dropdown-item d-flex align-items-center"
						href="/logout"> <i class="bi bi-box-arrow-right"></i> <span>Đăng xuất
								</span>
					</a></li>
