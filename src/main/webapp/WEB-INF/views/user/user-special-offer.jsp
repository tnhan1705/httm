...
<div class="span9">
	...
	<h4>
		20% Discount Special offer<small class="pull-right"> 40
	...
	<div class="tab-content">
		<div class="tab-pane" id="listView">
			<div class="row">
				...
				<div class="span4">
					...
					<a class="btn btn-small pull-right" href="/user//user/product_details">View
				...
				<div class="span3 alignR">
					<form class="form-horizontal qtyFrm">
						...
						</label><br /> <a href="/user//user/product_details"
							class="btn btn-large btn-primary"> Add to <i
							class=" icon-shopping-cart"></i></a> <a href="/user//user/product_details"
			...
			<div class="row">
				...
				<div class="span4">
					...
					<p>Lorem Ipsum is simply dummy text of the printing and
						typesetting industry. Lorem Ipsum has been the industry's standard
						dummy text ever since the 1500s ...</p>
					<a class="btn btn-small pull-right" href="/user/product_details">View
						Details</a> <br class="clr" />
				</div>
				<div class="span3 alignR">
					<form class="form-horizontal qtyFrm">
						...
						<label class="checkbox"> <input type="checkbox">
							Adds product to compair
						</label><br /> <a href="/user/product_details"
							class="btn btn-large btn-primary"> Add to <i
							class=" icon-shopping-cart"></i></a> <a href="/user/product_details"
							class="btn btn-large"><i class="icon-zoom-in"></i></a>
					</form>
				</div>
			</div>
		...
		<div class="tab-pane  active" id="blockView">
			<ul class="thumbnails">
				<li class="span3">
					<div class="thumbnail">
						<a href="/user/product_details"><img
							src="themes/images/products/b1.jpg" alt="" /></a>
						<div class="caption">
							<h5>Manicure &amp; Pedicure</h5>
							<p>Lorem Ipsum is simply dummy text.</p>
							<h4 style="text-align: center">
								<a class="btn" href="/user/product_details"> <i
